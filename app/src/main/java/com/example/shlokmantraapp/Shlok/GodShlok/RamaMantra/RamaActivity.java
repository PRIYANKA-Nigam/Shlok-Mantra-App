package com.example.shlokmantraapp.Shlok.GodShlok.RamaMantra;
...
public class RamaActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId()==R.id.hi){
            ...
            String s="Rama Mantra : "+t1.getText().toString()+"\n\n"+t2.getText().toString()+"\n\n"+t3.getText().toString()+"\n\n";
    ...
    private void ShowLang() {
        ...
        AlertDialog.Builder mbuild=new AlertDialog.Builder(RamaActivity.this);
