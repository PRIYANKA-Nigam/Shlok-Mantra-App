    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (s){
            case "Maa Lakshmi Arti":
                t2.setText(getString(R.string.a)); break;
            case "Maa Durga Arti":
                t2.setText(getString(R.string.b)); break;
            case "Lord Ganesha Arti":
                t2.setText(getString(R.string.c)); break;
            case "Lord Shiva Arti":
                t2.setText(getString(R.string.d)); break;
            case "Maa Kali Arti":
                t2.setText(getString(R.string.e));break;
            case "Maa Saraswati Arti":
                t2.setText(getString(R.string.f));break;
            case "Lord Hanumaan Arti":
                t2.setText(getString(R.string.g));break;
            case "Lord Rama Arti":
                t2.setText(getString(R.string.h));break;
            case "Maa Santoshi Arti":
                t2.setText(getString(R.string.i));break;
            case "Maa Gayatri Arti":
                t2.setText(getString(R.string.j));break;
            case "Lord Krishna Arti":
                t2.setText(getString(R.string.k));break;
            case "Lord Vishnu Arti":
                t2.setText(getString(R.string.l));break;
            case "Lord Brahma Arti":
                t2.setText(getString(R.string.m));break;
            case "Shani Dev Arti":
                t2.setText(getString(R.string.n));break;
        }
